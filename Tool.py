#Stock prediction tool that uses Long Short Term Memory or LSTM to predict
# closing price on a particular stock
...
#Tool.stockPlot(Tool.stockQuote('AAPL'))
#Tool.futurePrediction(Tool.data, Tool.model)
#Tool.trainData(Tool.stockQuote('AAPL'))
#Tool.predictionPlot()
